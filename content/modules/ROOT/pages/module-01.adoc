...
** SE Linux prevents naive httpd to connect to Mysql.
Solution: `setsebool -P httpd_can_network_connect_db=1`
** Convert2Rhel fails when detecting some kernel modules.
...
You have converted from Centos to RHEL, and it's displayed in Arc.
