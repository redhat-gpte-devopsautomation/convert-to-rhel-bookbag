...
image::Northwind_Sample_Data.jpg[55%,55%, align=center]
...
+
image::Azure_Arc_Portal_A.png[55%,55%,align=center]
+
...
+
image::Azure_Arc_Portal_B.png[55%,55%,align=center]
...
** Solution 1: `echo "export CONVERT2RHEL_ALLOW_UNAVAILABLE_KMODS=1" >> ~/.bashrc`
** Solution 2: `echo "export CONVERT2RHEL_TAINTED_KERNEL_MODULE_CHECK_SKIP=1" >> ~/.bashrc`
** Solution 3: `echo "export CONVERT2RHEL_SKIP_KERNEL_CURRENCY_CHECK=1" >> ~/.bashrc`
** Solution 4: `echo "export CONVERT2RHEL_OUTDATED_PACKAGE_CHECK_SKIP=1" >> ~/.bashrc`
