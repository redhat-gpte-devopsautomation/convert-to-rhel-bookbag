...
. Browse to link:{web_app}[Sample Web App] to verify the web app is running.
+
.Sample Output
+
...
. Verify the Web Application still functions by browsing to link:http://{web_app}[Sample Web App] to verify the web app is running.
+
.Sample Output
+
